...
const file_captcha_proto_rawDesc = "" +
	...
	"\n" +
	"GetCaptcha\x12!.todoing.api.v1.GetCaptchaRequest\x1a\".todoing.api.v1.GetCaptchaResponseB5Z3github.com/axfinn/todoIngPlus/backend-go/pkg/api/v1b\x06proto3"
